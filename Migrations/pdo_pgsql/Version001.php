...
class Version001 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE t_navitia_entity_nav '
            . '(nav_id INT NOT NULL, nav_name VARCHAR(255) NOT NULL, nav_name_canonical VARCHAR(255)NOT NULL,'
            . ' nav_email VARCHAR(255) NOT NULL, nav_email_canonical VARCHAR(255) NOT NULL, PRIMARY KEY(nav_id));');
        $this->addSql('ALTER TABLE t_navitia_entity_nav '
            . 'ADD COLUMN nav_created timestamp(0) without time zone DEFAULT NOW();');
        $this->addSql('ALTER TABLE t_navitia_entity_nav ALTER COLUMN nav_created SET NOT NULL;');
        $this->addSql('ALTER TABLE t_navitia_entity_nav '
            . 'ADD COLUMN nav_updated timestamp(0) without time zone DEFAULT NOW();');
        ...
        $this->addSql('ALTER TABLE tr_customer_cus ADD CONSTRAINT FK_784FEC5FDB6A43B2 FOREIGN KEY (cus_navitia_entity) '
            . 'REFERENCES t_navitia_entity_nav (nav_id) NOT DEFERRABLE INITIALLY IMMEDIATE;');
        ...
        $this->addSql('CREATE TABLE t_navitia_token_nat '
            . '(nat_id INT NOT NULL, nav_id INT DEFAULT NULL, nat_token VARCHAR(255) NOT NULL, '
            . 'nat_is_active BOOLEAN NOT NULL, nat_created TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, '
            . 'nat_updated TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(nat_id));');
        $this->addSql('CREATE INDEX IDX_356E8DADF03A7216 ON t_navitia_token_nat (nav_id);');
        $this->addSql('ALTER TABLE t_navitia_token_nat '
            . 'ADD CONSTRAINT FK_356E8DADF03A7216 FOREIGN KEY (nav_id) '
            . 'REFERENCES t_navitia_entity_nav (nav_id) NOT DEFERRABLE INITIALLY IMMEDIATE;');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX customer_id_external_coverage_id_external_network_id_idx ON t_perimeter_per '
            . 'USING btree (nav_id, per_external_coverage_id COLLATE pg_catalog."default", '
            . 'per_external_network_id COLLATE pg_catalog."default");');

        $this->addSql('DROP INDEX IDX_6B5760DAF03A7216;');
        $this->addSql('alter table t_perimeter_per rename column nav_id to cus_id;');
        $this->addSql('ALTER TABLE t_perimeter_per ADD CONSTRAINT fk_6b5760dabc4ee2b0 FOREIGN KEY (cus_id) '
            . 'REFERENCES tr_customer_cus (cus_id) MATCH SIMPLE ON UPDATE NO ACTION ON DELETE NO ACTION;');
